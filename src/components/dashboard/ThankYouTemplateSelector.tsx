...
interface ThankYouTemplateSelectorProps {
  webinarId: string
  currentTemplateId?: string | null
  onChange?: (templateId: string | null) => void
}

export default function ThankYouTemplateSelector({
  webinarId,
  currentTemplateId,
  onChange
}: ThankYouTemplateSelectorProps) {
  ...
  const [previewTemplate, setPreviewTemplate] = useState<ThankYouTemplate | null>(null)
  ...
  const handleTemplateChange = async (templateId: string | null) => {
    ...
    try {
      const response = await fetch(`/api/webinars/${webinarId}`, {
        ...
        body: JSON.stringify({ thankYouTemplateId: templateId })
      })
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">
          Choose which template to display after users register for your webinar.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-sm text-gray-600">
            System will use the default thank you template
          </p>
        </div>
          ...
          >
            ...
            <div className="flex-1 overflow-auto p-4 bg-gray-50">
              ...
              <p className="text-xs text-gray-500 mt-2 text-center">
                Note: This is a preview with placeholder data. Actual page will show real webinar details.
              </p>
            </div>
          </div>
        </div>
