...
const UrgencyRegistrationModal = dynamic(() => import('./components/UrgencyRegistrationModal'), {
  loading: () => <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70"><div className="bg-white p-4 rounded-lg">Loading...</div></div>,
  ssr: false
})
