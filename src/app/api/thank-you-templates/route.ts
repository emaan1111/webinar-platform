...
export async function POST(request: Request) {
  try {
    ...
    const template = await prisma.thankYouTemplate.create({
      data: {
        name,
        description,
        htmlCode,
    ...
    console.error('Error creating thank you template:', error)
