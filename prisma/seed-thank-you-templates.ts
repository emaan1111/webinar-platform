...
<body>
        ...
        <div class="container">
            ...
            <div class="steps-container">
                ...
                <div class="step-card">
                    ...
                    <p class="reward-text">"Whoever calls others to guidance will have a reward like the one who follows it." - Hadith</p>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                <h3 class="footer-title">Emaan Power</h3>
                <p class="footer-description">
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased overflow-x-hidden">
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-glass p-6 md:p-8 border border-royal-700/30 mb-5 fade-in-up">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-6">
                ...
                <div class="text-left md:text-center flex-1">
                    ...
                    <div class="text-lg md:text-2xl font-serif text-royal-950 font-bold mb-1 tracking-wide">
                        {{webinarDate}}
                    </div>
                ...
                <!-- PRIMARY CTA -->
                <a href="{{joinLink}}" class="btn-shine w-full md:w-auto bg-royal-800 hover:bg-royal-700 text-white font-bold text-base md:text-lg py-4 md:py-5 px-8 rounded-full shadow-lg shadow-royal-900/20 transition transform hover:-translate-y-1 border border-royal-600 text-center">
                    GO TO WEBINAR ROOM
                </a>
            </div>
    ...
    <script>
        ...
        // 2. SHARE LINK LOGIC
        // ===========================
        const shareUrl = "{{referralLink}}" || "{{webinar.registrationUrl}}" || window.location.href; 
        const shareText = "I just registered for {{webinarTitle}}! You should join me. " + shareUrl;
        const shareTextTwitter = "Check out this free masterclass: " + shareUrl;
  ...
  // Rising Heroes Template
  const risingHeroesTemplate = await prisma.thankYouTemplate.upsert({
    where: { name: 'Rising Heroes' },
    update: {},
    create: {
      name: 'Rising Heroes',
      description: 'Premium gold and royal blue design with confetti and animations',
      isSystem: false,
      htmlCode: `<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased overflow-x-hidden">
  ...
  console.log('✅ Rising Heroes template created:', risingHeroesTemplate.name)
